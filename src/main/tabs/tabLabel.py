...
class TabLabel(Gtk.Box):
    ...
    label: ClassVar[Gtk.Label]
    icon: ClassVar[Gtk.Image]

    def __init__(self, label_text: str, drawer_icon_file_name: str):
        ...
        # icon
        if drawer_icon_file_name:
            self.icon = Gtk.Image.new_from_pixbuf(self.getPixBuffFromFile(drawer_icon_file_name))
        else:
        ...
        # label
        lbl_event_box: Gtk.EventBox = Gtk.EventBox.new()
    ...
    def getPixBuffFromFile(self, fileName: str) -> GdkPixbuf.Pixbuf:
